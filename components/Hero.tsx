      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-4 px-2"
          >
            <p className="text-xl md:text-2xl text-white/70 font-light mb-1">Hello, I'm</p>
            ...
            <p className="text-white/50 text-lg mt-3 tracking-wide">You're in the right place.</p>
          </motion.div>
